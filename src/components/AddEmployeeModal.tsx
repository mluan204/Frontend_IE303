...
function AddEmployeeModal({ isOpen, onClose, onEmployeeAdded }: AddEmployeeModalProps) {
      ...
      <div className="bg-white rounded-2xl w-4/5 max-h-[540px] shadow-lg overflow-hidden">
        ...
        <div className="overflow-y-auto h-[calc(440px-48px)] px-6 pb-4 scrollbar-hide">
          <div className="grid grid-cols-4 gap-6">
            ...
            {/* Column 2 */}
            <div className="space-y-4">
              {([ "name", "position", "address", "gender"] as (keyof Employee)[]).map((field) => (
                <div key={field}>
                  ...
                  <input
                    type="text"
                    name={field}
                    value={field === "gender" ? (newEmployee[field] ? "Nam" : "Nữ") : String(newEmployee[field]) }
